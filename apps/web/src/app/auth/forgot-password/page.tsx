    ...
    <main className="min-h-screen flex items-center justify-center p-4 sm:p-8 bg-slate-50 dark:bg-slate-950">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-slate-800 dark:text-slate-100">Reset your password</h1>
        ...
        {sent ? (
          <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-2xl p-6 shadow-sm text-center space-y-4">
            <div className="text-3xl">📬</div>
            <p className="text-sm text-gray-600 dark:text-slate-300">
              We sent a reset link to <strong className="text-slate-800 dark:text-slate-100">{email}</strong>. Check your inbox and click the link to set a new password.
            </p>
            <p className="text-xs text-gray-400 dark:text-slate-500">Didn't receive it? Check your spam folder or try again.</p>
            <button
